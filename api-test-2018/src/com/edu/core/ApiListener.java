...
import com.edu.core.FreemarkerTemplateEngine;
	...
	public void onFinish(ITestContext testContext) {
		...
		try {
			if (ReadPro.getPropValue("enable_email").equals("true")) {
				...
				String emailTitle = ReadPro.getPropValue("mail_title") + "----" + nowDateTime;
				...
				try {
					if (this.getFailedTests() != null && this.getFailedTests().size() > 0) {
						...
						MailUtil.sendEmail(ReadPro.getPropValue("success_to_mail"), emailTitle,
								emailContent);
